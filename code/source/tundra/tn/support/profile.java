...
// -----( CREATED: 2014-05-15 13:28:43.670
...

{
	...
	public static IData get(String id, boolean cached) throws com.wm.app.tn.profile.ProfileStoreException, java.io.IOException {
	  IData output = null;
	
	  if (cached) output = cache.profiles.get(id);
